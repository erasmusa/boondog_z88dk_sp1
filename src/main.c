...
struct sp1_Rect game_area = {1, 1, 32, 23}; // define game area (x,y,w,h)
struct keys_struct game_keys = {IN_KEY_SCANCODE_o, IN_KEY_SCANCODE_p, IN_KEY_SCANCODE_SPACE, IN_KEY_SCANCODE_q, IN_KEY_SCANCODE_a, IN_KEY_SCANCODE_h}; // define the default keys
